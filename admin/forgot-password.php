                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                       ...
                                       <div class="form-group ">
                                        <div class="col-xs-12">
                                            <p><b>Enter Email Address to recover your password</b></p>
                                                <input class="form-control" type="text" required="" name="email" placeholder=" Enter Email Adress" autocomplete="off">
                                            </div>
                                           <!-- <div class="col-xs-12">
